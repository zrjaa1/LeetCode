 ...
 *  *Thoughts*
 *  sol1: recursion
 *  sol2: using stack. Always go left if non-null, and pop and go right if null. Same for pre-order, just when to add res is different.
 *  sol3: NOT RECOMMENDED. Stack + prev, NOT RECOMMENDED for in-order and pre-order.
 *  sol4: Another stack solution. Using logical tree(containing right subtree), 在出栈时加入res list(not implemented yet)
 */

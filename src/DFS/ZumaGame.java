...
public class ZumaGame {
    /**
     * My solution, this is not a completely working solution. As it only considered inserting a ball that the same as its neighbor.
     * This won't work for test case: board = "RRWWRRBBRR", hand = "WB" -> "RRWWRRBBRWR" -> "RRWWRRBBBRWR" -> "RRWWRRRWR" -> "RRWWWR" -> "RRR" -> Empty
     */
    ...
    private void dfs(String board, int count) {
        ...
        for (int i = 0; i < board.length(); i++) {
            ...
            if (seqLen + cc >= 3) {
                ...
                charCount.put(cur, charCount.getOrDefault(cur, 0) + numMoves); // backtrace
            }
            i = t - 1; // we leave it alone, and don't insert any ball for for this consecutive sequence.
        }
    }

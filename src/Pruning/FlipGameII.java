...
/**
 * The returning value of dfs is not if the current player can guarantee a win, but what is the result of current player with current state.
 * Since there is no condition of likely to win, it's either 100% win or 100% lose. Since your component will play optimally.
 */
